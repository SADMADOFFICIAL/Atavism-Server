...
#
### Are players allowed to register/create accounts?
...
atavism.remote_db_timezone=UTC
atavism.remote_db_driver=com.mysql.cj.jdbc.Driver
...
###
### Number of threds that is used to recive Incoming Messages (default 32)
### atavism.AgentDataThreadPoolSize=32
###
### Number ot threads used to recive RDP package (default 24)
### atavism.PacketQueueThreadPoolSize=24
###
### Number threds used to handle resend Packeds (default 8)
### atavism.PacketResendThreadPoolSize=8
###
atavism.PacketQueueThreadPoolSize=3
#
atavism.PacketResendThreadPoolSize=2
#
atavism.AgentDataThreadPoolSize=2
#
###
### 
###atavism.ugs.project_id=
###
#
atavism.auth.Xms=8m
atavism.auth.Xmx=128m
