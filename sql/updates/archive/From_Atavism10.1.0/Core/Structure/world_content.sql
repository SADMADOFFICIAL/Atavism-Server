-- 
-- Script date 28.08.2020 20:02:27
...
--
-- Alter column `updatetimestamp` on table `quest_requirement`
--
ALTER TABLE quest_requirement 
  CHANGE COLUMN updatetimestamp updatetimestamp TIMESTAMP NULL DEFAULT '2000-01-01 00:00:00';
...
--
-- Alter column `updatetimestamp` on table `item_templates_options`
--
...
--
ALTER TABLE abilities 
  ADD COLUMN pulseCostType VARCHAR(32) DEFAULT ' ';
